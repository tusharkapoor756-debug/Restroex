import { LocalOCRWorkerService } from '../apps/backend/src/modules/menu/services/ocr-worker.service';
import { SpatialLayoutReconstructor } from '../apps/backend/src/modules/menu/services/spatial-layout.service';
import { DeterministicMenuParser } from '../apps/backend/src/modules/menu/services/deterministic-parser.service';
import { OCRToken } from '../apps/backend/src/modules/menu/types/menu-import.types';

// Mock Synthetic Datasets representing 10 real menu formats
...
function runValidationBenchmark() {
  ...
  for (const ds of benchmarkDatasets) {
    ...
    const lines = spatialService.groupTokensIntoLines(ds.tokens as OCRToken[]);
